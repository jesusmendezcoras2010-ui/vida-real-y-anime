let classifier;
let imageModelURL = 'https://teachablemachine.withgoogle.com/models/DHedXkBZT/'; 
let video;
...
function draw() {
  ...
  if (label === "Class 1" && confidence > 0.85) {
    noFill();
...
function drawCartoonUI() {
  ...
  let msg = (label === "Class 1") ? "ANIME DETECTADO" : "🔍 BUSCANDO ANIME...";
